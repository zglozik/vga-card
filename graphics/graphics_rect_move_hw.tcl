...
# Thu Aug 21 14:34:11 AEST 2025
# DO NOT MODIFY


# 
# graphics_rect_move "graphics_rect_move" v1.0
#  2025.08.21.14:34:11
# 
# 
...
set_module_property NAME graphics_rect_move
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Private IPs"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME graphics_rect_move
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL graphics_rect_move
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file graphics_rect_move.sv SYSTEM_VERILOG PATH graphics_rect_move.sv {CONTAINS_INLINE_CONFIGURATION TOP_LEVEL_FILE}
...
set_parameter_property MM_START_ADDRESS DESCRIPTION ""
set_parameter_property MM_START_ADDRESS HDL_PARAMETER true
add_parameter MAX_PENDING_READS INTEGER 50 ""
set_parameter_property MAX_PENDING_READS DEFAULT_VALUE 50
...
set_parameter_property MAX_PENDING_READS DESCRIPTION ""
...
set_interface_property mm_master_sdram maximumPendingReadTransactions 50
...
add_interface_port mm_master_sdram mm_read read Output 1
add_interface_port mm_master_sdram mm_address address Output 32
add_interface_port mm_master_sdram mm_byteenable byteenable Output 2
add_interface_port mm_master_sdram mm_waitrequest waitrequest Input 1
add_interface_port mm_master_sdram mm_readdata readdata Input 16
add_interface_port mm_master_sdram mm_readdatavalid readdatavalid Input 1
